...
> **For agentic workers:** REQUIRED: Use super:subagent-driven-development (if subagents available) or super:executing-plans to implement this plan.
...
**Spec:** .super/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to .super/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use super:subagent-driven-development (if subagents available) or super:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
