...
**Goal:** Make super defer to native harness worktree systems when available, fall back to manual git worktrees when not, and fix three known finishing bugs.
...
**Spec:** `.super/specs/2026-04-06-worktree-rototill-design.md`
...
**If worktree path is under `.worktrees/` or `worktrees/`:** Super created this worktree — we own cleanup.
