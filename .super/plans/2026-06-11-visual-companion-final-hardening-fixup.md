...
**Spec:** `.super/specs/2026-06-11-visual-companion-final-hardening-fixup-design.md`
...
- Modify: `.super/plans/2026-06-09-visual-companion-issues.md`
...
```bash
cd /Users/drewritter/.codex/worktrees/59f6/super/tests/brainstorm-server
node server.test.js
```
...
```bash
cd /Users/drewritter/.codex/worktrees/59f6/super
...
In `.super/plans/2026-06-09-visual-companion-issues.md`, replace the disposition rows for A2, D1, D2, D3, and D4 with:
...
```bash
git diff -- skills/brainstorming/visual-companion.md .super/plans/2026-06-09-visual-companion-issues.md
```
...
```bash
git add skills/brainstorming/visual-companion.md .super/plans/2026-06-09-visual-companion-issues.md
...
```bash
git -C /Users/drewritter/.codex/worktrees/59f6/super-evals rev-parse HEAD
git -C /Users/drewritter/.codex/worktrees/59f6/super-evals status --short --branch
```

If the eval worktree is not at that path, run the same commands in `/Users/drewritter/prime-rad/super-evals`.
...
- [ ] Every requirement in `.super/specs/2026-06-11-visual-companion-final-hardening-fixup-design.md` maps to one of the tasks above.
