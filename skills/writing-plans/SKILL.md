...
**Context:** If working in an isolated worktree, it should have been created via the `super:using-git-worktrees` skill at execution time.

**Save plans to:** `.super/plans/YYYY-MM-DD-<feature-name>.md`
...
**"Plan complete and saved to `.super/plans/<filename>.md`. Two execution options:**
