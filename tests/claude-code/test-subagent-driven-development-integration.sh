...
mkdir -p src test .super/plans

# Create a simple implementation plan
cat > .super/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at .super/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at .super/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"super:subagent-driven-development"' "$SESSION_FILE"; then
